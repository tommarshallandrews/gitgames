...
<div class="nodewrap__fields clearfix" style="height: 430px;">    
    <div class="field field-name-field-image field-type-image field-label-hidden"><div class="field-items"><div class="field-item even"><img typeof="foaf:Image" src="uploads/{{$pitcher->image}}" width="281" height="305" alt="" class="loaded"></div></div></div><div class="field field-name-field-title field-type-text field-label-hidden"><div class="field-items"><div class="field-item even">{{$pitcher->name}}</div></div></div><div class="field field-name-field-body field-type-text-with-summary field-label-hidden"><div class="field-items"><div class="field-item even"><p><strong>{{$pitcher->job}}</strong></p>
<p>{{$pitcher->text}}</p>
<p><a href="mailto:phil.mcneilage@cl-uk.com" class="mailto">{{$pitcher->email}}<span class="mailto"><span class="element-invisible"> (link sends e-mail)</span></span></a>&nbsp;| Call: {{$pitcher->phone}} |&nbsp;</p>
</div></div></div></div>
</div>
</div>
