...
<div class="field field-name-field-attachment field-type-file field-label-above"><div class="field-label">Attachment:&nbsp;</div><div class="field-items">
...
<span class="file"><img class="file-icon" alt="" title="application/pdf" src="/modules/file/icons/application-pdf.png"> <a href="uploads/{{$document->file}}" type="application/pdf; length=5153333">{{$document->title}}</a></span></div>
  ...
  <div class="nodewrap__fields clearfix" style="height: 610px;">    
    <div class="field field-name-field-image field-type-image field-label-hidden"><div class="field-items"><div class="field-item even"><img typeof="foaf:Image" src="uploads/{{$pitch->document_image}}" width="782" height="555" alt="" class="loaded"></div></div></div></div>
