...
<div class="view-content">
  ...
  <div class="col-sm-6">
    ...
    <div class="field field-name-field-thumbnail-image field-type-image field-label-hidden"><div class="field-items"><div class="field-item even" rel="" resource="uploads/{{$pitch->why_image}}"><img typeof="foaf:Image" src="uploads/{{$pitch->why_image}}" width="480" height="350" alt=""></div></div></div><span property="dc:title" content="Why Cunningham Lindsey" class="rdf-meta"></span>    </div>
  </div>
  </div>
